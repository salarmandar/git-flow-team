...
{
    public class AdhocJobDetailJobPickedUpView
    {
        public AdhocJobHeaderPickedUpView AdhocJobHeaderView { get; set; }
        ...
        public string otc_lock_user { get; set; } = "";

        public string otc_lock_mode { get; set; } = "R";

        public bool isFromOcean { get; set; } = true;
    ...
    public class AdhocJobHeaderPickedUpView
    {
